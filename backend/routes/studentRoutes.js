...
const { registerStudent, getStudent, getAllStudents, updateStudent, deleteStudent, csvStudent, getStudentsByHostel } = require('../controllers/studentController');
...
router.post('/register-student', [
    ...
    check('roll_no', 'Roll number of at least 7 digit is required').isLength(7),
    check('room_no').optional(),
