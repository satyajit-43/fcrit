...
const registerStudent = async (req, res) => {
    ...
    const { name, roll_no, batch, dept, course, email, father_name, contact, address, dob, hostel, password } = req.body;
    try {
...
// @route   GET /api/student/hostel/:hostelId
// @access  Public
const getStudentsByHostel = async (req, res) => {
    try {
    ...
    //   console.log(hostel);
      ...
      // Get students without room allocation
